      ...
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-12 pt-20 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredCases.map((case_) => (
            <div
              key={case_.id}
              onClick={() => console.log('Navigate to:', case_.id)}
              className="group bg-white rounded-[32px] p-8 shadow-soft-xl border border-black/20 hover:shadow-2xl hover:-translate-y-1 transition-all cursor-pointer relative"
            >
              {/* Arrow Icon */}
